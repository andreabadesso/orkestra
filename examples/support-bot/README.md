...
### Customer Tiers and SLAs

The example implements tier-based SLAs:
...
The AI confidence threshold is set to 0.8 (80%). Messages with lower confidence are automatically escalated to humans.

Keywords that trigger automatic human review:
- urgent, emergency
...
The example includes mock customer data:
